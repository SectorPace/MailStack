 ...
 *
 *   installed-version = v0.8.0-beta.9 (canonical), target v0.5.3-rc.1  -> rejected (rc 1)
...
CUR=v0.8.0-beta.9   # canonical, matches package.json / VERSION
OLDER=v0.5.3-rc.1
NEWER=v0.9.0
...
# Missing installed-version file -> fall back to script VERSION (0.8.0-beta.9);
